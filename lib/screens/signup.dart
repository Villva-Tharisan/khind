...
class _SignUpState extends State<SignUp> {
  ...
  _init() {
    ...
    state = new States(
        countryId: "", state: "--Select State--", stateId: "", stateCode: "");
  ...
  _fetchCities(stateId) async {
    ...
    List<City> tempCities =
        newCities.where((e) => citySet.add(e.city!)).toList();
    ...
    newCities.forEach((elem) {
      if (elem.postcode != null && elem.postcode != "") {
        tempPostcodes.add(Postcode.fromJson(
            {'postcode_id': elem.postcodeId, 'postcode': elem.postcode}));
      }
    });
    List<Postcode> newPostcodes =
        tempPostcodes.where((e) => postcodeSet.add(e.postcode!)).toList();
    ...
    return Container(
        ...
        child: Form(
            ...
            child: Column(
                ...
                children: [
                  Text("Step 1 : Fill in your information",
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: 'First Name',
                        hintStyle: focusFirstName.hasFocus
                            ? TextStyles.textPrimary
                            : TextStyles.textGreyDark,
                        contentPadding: const EdgeInsets.symmetric(vertical: 5),
                        border: UnderlineInputBorder(
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: 'Last Name',
                        hintStyle: focusLastName.hasFocus
                            ? TextStyles.textPrimary
                            : TextStyles.textGreyDark,
                        contentPadding: const EdgeInsets.symmetric(vertical: 5),
                        border: UnderlineInputBorder(
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintStyle: focusMobile.hasFocus
                            ? TextStyles.textPrimary
                            : TextStyles.textGreyDark,
                        contentPadding: const EdgeInsets.symmetric(vertical: 5),
                        border: UnderlineInputBorder(
            ...
            child: Column(
                ...
                children: [
                  Row(children: [
                    ...
                    SizedBox(width: 20),
                    Flexible(
                        child: Text("Step 2 : Fill in your address",
                            style: TextStyles.textSecondaryBold))
                  ]),
                  SizedBox(height: 20),
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: 'Address 1',
                        hintStyle: focusAddress1.hasFocus
                            ? TextStyles.textPrimary
                            : TextStyles.textGreyDark,
                        contentPadding: const EdgeInsets.symmetric(vertical: 5),
                        border: UnderlineInputBorder(
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: 'Address 2',
                        hintStyle: focusAddress2.hasFocus
                            ? TextStyles.textPrimary
                            : TextStyles.textGreyDark,
                        contentPadding: const EdgeInsets.symmetric(vertical: 5),
                        border: UnderlineInputBorder(
            ...
            child: Column(
                ...
                children: [
                  Row(children: [
                    ...
                    SizedBox(width: 20),
                    Flexible(
                        child: Text("Step 3 : Create password",
                            style: TextStyles.textSecondaryBold))
                  ]),
                  SizedBox(height: 20),
                  Stack(children: [
