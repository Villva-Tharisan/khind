...
class _SignInState extends State<SignIn> {
      ...
      if (response?.length > 0) {
        if (response['error'] != null) {
          ...
          final Map<String, dynamic> mapRest = {
            'first_name':
                newResp['firstname'] != null ? newResp['firstname'] : "",
            'last_name': newResp['lastname'] != null ? newResp['lastname'] : "",
            'email':
                newResp['email'] != null ? newResp['email'].toLowerCase() : '',
          ...
          children: [
            ...
            RoundButton(
              ...
              onPressed: () {
                ...
                Navigator.pushNamed(context, 'EwarrantyProductManual',
                    arguments: true);
              },
            ),
          ],
  ...
  _renderBottom() {
    return Column(children: [
      ...
      SizedBox(height: 3),
      InkWell(
          child: Text("JOIN US HERE",
              style: TextStyles.textDefaultBold.copyWith(fontSize: 18)),
          onTap: () {
            setState(() {
              errorMsg = "";
            });
